...
+ 当根文件系统镜像是ext4分区时，**可以进入shell（Bash）界面进行操作。**

**可以进行完整的读操作，写操作相关的内容还未完全实现，可以进行简单的写验证。**

### 后续工作

+ 内核运行后可以动态挂载分区（即根文件系统镜像为多分区）
+ 性能测试与功能测试

### 演示视频

链接: https://pan.baidu.com/s/1SgfR2e8cGKZ0hZoNlSjvhg?pwd=y6xk 提取码: y6xk 
--来自百度网盘超级会员v5的分享
